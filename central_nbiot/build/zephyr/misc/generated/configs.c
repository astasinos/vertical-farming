...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_MODE_PREFERENCE_NBIOT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_MODE_PREFERENCE, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_RAI_REQ_VALUE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_NETWORK_USE_FALLBACK, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_NETWORK_TIMEOUT, 1200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_LC_MODEM_SLEEP_NOTIFICATIONS, 1);
